...
PMF_PATH = (
    "/Users/RyanLazar/Dropbox/UCT/Masters/MetaDynamics/MetaD_aLRha12aLRha_GLY.pmf"
)
...
COLOUR_MAP_GRADIENT = (
    cm.coolwarm
)  # cm.gray looks better for overlay see more options at https://matplotlib.org/3.1.0/tutorials/colors/colormaps.html
